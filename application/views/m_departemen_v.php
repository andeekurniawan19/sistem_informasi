				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="kode_depart" name="kode_depart" required>
						...
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="nama_depart" name="nama_depart" required>
								<div class="form-control-focus">
								</div>
							</div>
						</div>
					...
					<form role="form" class="form-horizontal" method="post" action="<?php echo $url_ubah;?>" enctype="multipart/form-data">
						<div class="form-body">
							...
							<div class="form-group form-md-line-input">
								...
								<div class="col-md-4">
									<input required type="text" class="form-control" name="nama_depart_modal" id="nama_depart_modal" >
									<div class="form-control-focus">
									</div>
								</div>
							</div>
