...
<button id="tambah_supplier" class="btn green">
Tambah Data Supplier <i class="fa fa-plus"></i>
</button>
</br>
</br>
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:center; vertical-align: middle;">
						<a class="btn default btn-xs purple" id="ubah" onclick="ubah_data_supplier(<?php echo $value->id_supplier?>);"><i class="fa fa-edit"></i> Ubah </a>
