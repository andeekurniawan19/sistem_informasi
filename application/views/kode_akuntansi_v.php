				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="anak_dari" name="anak_dari" required>
								<div class="form-control-focus">
								</div>
							</div>
						</div>
						...
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="kode_grup" name="kode_grup" required>
								<div class="form-control-focus">
								</div>
							</div>
						</div>
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="kode_sub" name="kode_sub" required>
								<div class="form-control-focus">
								</div>
							</div>
						</div>
